...
public class UpdateProviderController {
	...
	/**
	 * This is the reset button for the update provider menu.
	 */
	@FXML
	...
	void onYesClick(Button button) {
		button.setOnAction(new EventHandler() {
			...
			public void handle(Event event) {
				...
				System.out.println("Clicked Yes to Update Provider.");
