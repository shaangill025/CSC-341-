...
public class Test {
	...
	public static void main(String[] args) {
		...
		Member mem1 = new Member(1,"Shaan","Gill","1137 Gertrude St","Waukesha","WI",53186,true,false);
		Member mem2 = new Member(2,"Shaan2","Gill2","1138 Gertrude St","Waukesha","WI",53186,true,false);
		Member mem3 = new Member(3,"Shaan3","Gill3","1139 Gertrude St","Waukesha","WI",53186,true,false);
		Member mem4 = new Member(4,"Shaan4","Gill4","1140 Gertrude St","Waukesha","WI",53186,true,false);
